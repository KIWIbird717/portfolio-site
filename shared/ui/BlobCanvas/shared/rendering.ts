...
import { palette as palleteColors } from "./palletes";
...
export class Rendering {
  ...
  constructor(canvas: HTMLCanvasElement, palette: typeof palleteColors) {
    this.canvas = canvas;
    const hex = "#" + palette.highlight.getHexString();
